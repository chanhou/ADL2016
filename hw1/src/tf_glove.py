...
class GloVeModel():
    ...
    def __fit_to_corpus(self, corpus, vocab_size, min_occurrences, left_size, right_size):
        ...
        self.__id_to_word = {i: word for i, word in enumerate(self.__words)}
    ...
    def train(self, num_epochs, log_dir=None, summary_batch_interval=1000,
        ...
        with tf.Session(graph=self.__graph) as session:
            ...
            for epoch in range(num_epochs):
                ...
                embedding1 = self.embeddings 
                with open('tmp/filter_glove.txt','wb') as f:
                    for i in range(len(self.__id_to_word)):
                        f.write(self.__id_to_word[i])
